    ...
    <div class="side-menu">
        ...
        <div class="info">
            ...
            <!-- <div class="member">
                ...
                <button onclick="location.href='Support_member.php'" type="button" class="homebtn">Support Members</button>

                <button onclick="location.href='academic_member.php'" type="button" class="homebtn">Academic Members</button>

                <button onclick="location.href='other_member.php'" type="button" class="homebtn">Other Members</button>
